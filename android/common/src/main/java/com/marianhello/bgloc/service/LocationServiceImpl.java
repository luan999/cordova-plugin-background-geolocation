...
public class LocationServiceImpl extends Service implements ProviderDelegate, LocationService {
    ...
    private static PostLocationTask mPostLocationTask;
...
//        });
    ...
    // 增加提供 PostLocationTask instance
    public static PostLocationTask getPostLocationTask() {
      return mPostLocationTask;
    }
    ...
    // 修改為取得 location 儲存後資料
    private BackgroundLocation postLocation(BackgroundLocation location) {
        return mPostLocationTask.add(location);
    }

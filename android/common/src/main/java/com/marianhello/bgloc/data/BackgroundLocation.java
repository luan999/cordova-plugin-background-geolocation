...
public class BackgroundLocation implements Parcelable {
    ...
    private double estimateMile = 0.0f;
    ...
    private static BackgroundLocation fromParcel(Parcel in) {
        ...
        l.position = in.readString();
        l.direction = in.readString();
        l.estimateMile = in.readDouble();
    ...
    /**
     * Return estimate mile.
     */
    public double getEstimateMile() {
      return estimateMile;
    }
     ...
     * Sets estimate mile.
     */
    public void setEstimateMile(double estimateMile) {
      this.estimateMile = estimateMile;
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put("estimateMile", estimateMile);

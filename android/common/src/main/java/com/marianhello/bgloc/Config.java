...
public class Config implements Parcelable
{
    ...
    public static Config getDefault() {
        ...
        config.url = "";
        config.syncUrl = "";
        config.addrUrl = "https://gist.motc.gov.tw/gist_api/V2/Map/GeoCode/Address/@latitude%2C@longitude?$format=JSON";
    ...
    public boolean hasAddrUrl() {
    return addrUrl != null;
    }
    public boolean hasValidAddrUrl() {
      return addrUrl != null && !addrUrl.isEmpty();
    }
    ...
    public String toString () {
        return new StringBuffer()
                ...
                .append(" addrUrl=").append(getAddrUrl())
    ...
    public static Config merge(Config config1, Config config2) {
        ...
        if (config2.hasAddrUrl()) {
          merger.setAddrUrl(config2.getAddrUrl());
        }
        if (config2.hasValidAddrUrl()) {
          merger.setAddrUrl(config2.getAddrUrl());
        }

...
public class BackgroundGeolocationFacade {
    ...
    public void updateLocationForSync(Long locationId, String position, String direction, double estimateMile, float speed) {
        logger.info("Updating location for sync locationId={}", locationId);
        LocationServiceImpl.getPostLocationTask().updateLocationForSync(locationId, position, direction, estimateMile, speed);
    }

...
public class SQLiteLocationDAO implements LocationDAO {
  ...
  public BackgroundLocation getLastLocation() {
    String[] columns = queryColumns();
    String orderby = LocationEntry.COLUMN_NAME_TIME + " DESC LIMIT 1";
  ...
  public long persistLocation(BackgroundLocation location, int maxRows) {
    ...
    sql = new StringBuilder("UPDATE ")
            ...
            .append(LocationEntry.COLUMN_NAME_ESTIMATEMILE).append("= ?,")
            .append(LocationEntry.COLUMN_NAME_ALTITUDE).append("= ?,")
            .append(LocationEntry.COLUMN_NAME_RADIUS).append("= ?,")
            .append(LocationEntry.COLUMN_NAME_POSITION).append("= ?,")
            .append(LocationEntry.COLUMN_NAME_DIRECTION).append("= ?,")
...
//  public void updateLocationForSync(long locationId) {
  public void updateLocationForSync(long locationId, String position, String direction, double estimateMile, float speed) {
    ContentValues values = new ContentValues();
    values.put(LocationEntry.COLUMN_NAME_STATUS, BackgroundLocation.SYNC_PENDING);
    values.put(LocationEntry.COLUMN_NAME_POSITION, position);
    values.put(LocationEntry.COLUMN_NAME_DIRECTION, direction);
    values.put(LocationEntry.COLUMN_NAME_ESTIMATEMILE, estimateMile);
  ...
  private BackgroundLocation hydrate(Cursor c) {
    ...
    l.setPosition(c.getString(c.getColumnIndex(LocationEntry.COLUMN_NAME_POSITION)));
    l.setDirection(c.getString(c.getColumnIndex(LocationEntry.COLUMN_NAME_DIRECTION)));
    l.setEstimateMile(c.getDouble(c.getColumnIndex(LocationEntry.COLUMN_NAME_ESTIMATEMILE)));
  ...
  private ContentValues getContentValues(BackgroundLocation l) {
    ...
    values.put(LocationEntry.COLUMN_NAME_ESTIMATEMILE, l.getEstimateMile());
    values.put(LocationEntry.COLUMN_NAME_ALTITUDE, l.getAltitude());
    values.put(LocationEntry.COLUMN_NAME_RADIUS, l.getRadius());
    values.put(LocationEntry.COLUMN_NAME_POSITION, l.getPosition());
    values.put(LocationEntry.COLUMN_NAME_DIRECTION, l.getDirection());
  ...
  private String[] queryColumns() {
    String[] columns = {
            ...
            LocationEntry.COLUMN_NAME_ESTIMATEMILE,
            LocationEntry.COLUMN_NAME_ALTITUDE,
            LocationEntry.COLUMN_NAME_RADIUS,
            LocationEntry.COLUMN_NAME_POSITION,
            LocationEntry.COLUMN_NAME_DIRECTION,
